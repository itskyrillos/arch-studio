...
{
    wp_enqueue_style('theme-style', get_template_directory_uri() . '/assets/dist/css/main.css', array(), rand(111,9999), 'all');
}
...
{
    wp_enqueue_script('theme-script', get_template_directory_uri() . '/assets/dist/js/main.bundle.js', array(), rand(111,9999), true);
}
